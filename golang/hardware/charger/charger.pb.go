...
var file_charger_proto_rawDesc = []byte{
	...
	0x1a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x73, 0x6f, 0x63, 0x22, 0x9c, 0x08, 0x0a, 0x0e, 0x54,
	...
	0x09, 0x52, 0x06, 0x65, 0x76, 0x73, 0x65, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x0f, 0x54, 0x72, 0x61,
...
var file_charger_proto_depIdxs = []int32{
	...
	24,  // 71: Goiot.Protocol.Charger.SampledValue.phase:type_name -> Goiot.Protocol.Charger.SampledValue.Phase
	16,  // 72: Goiot.Protocol.Charger.TelemetryReq.component:type_name -> Goiot.Protocol.Charger.Components
	94,  // 73: Goiot.Protocol.Charger.TelemetryReq.values:type_name -> Goiot.Protocol.Charger.SampledValue
	17,  // 74: Goiot.Protocol.Charger.WarningReq.level:type_name -> Goiot.Protocol.Charger.WarningLevel
	16,  // 75: Goiot.Protocol.Charger.WarningReq.component:type_name -> Goiot.Protocol.Charger.Components
	17,  // 76: Goiot.Protocol.Charger.GetWarningReq.level:type_name -> Goiot.Protocol.Charger.WarningLevel
	25,  // 77: Goiot.Protocol.Charger.GetBaseReportReq.type:type_name -> Goiot.Protocol.Charger.GetBaseReportReq.ReportBaseEnumType
	105, // 78: Goiot.Protocol.Charger.NotifyReportReq.reportData:type_name -> Goiot.Protocol.Charger.ReportDataType
	106, // 79: Goiot.Protocol.Charger.ReportDataType.component:type_name -> Goiot.Protocol.Charger.ComponentType
	107, // 80: Goiot.Protocol.Charger.ReportDataType.variable:type_name -> Goiot.Protocol.Charger.VariableType
	108, // 81: Goiot.Protocol.Charger.ReportDataType.variableAttribute:type_name -> Goiot.Protocol.Charger.VariableAttributeType
	172, // 82: Goiot.Protocol.Charger.SetVariablesReq.setVariableData:type_name -> Goiot.Protocol.Charger.SetVariablesReq.SetVariableData
	26,  // 83: Goiot.Protocol.Charger.GetLogReq.logType:type_name -> Goiot.Protocol.Charger.GetLogReq.LogType
	173, // 84: Goiot.Protocol.Charger.GetLogReq.log:type_name -> Goiot.Protocol.Charger.GetLogReq.LogParametersType
	27,  // 85: Goiot.Protocol.Charger.GetLogConf.status:type_name -> Goiot.Protocol.Charger.GetLogConf.LogStatusEnumType
	28,  // 86: Goiot.Protocol.Charger.LogStatusNotificationReq.status:type_name -> Goiot.Protocol.Charger.LogStatusNotificationReq.UploadLogStatusEnumType
	7,   // 87: Goiot.Protocol.Charger.IdTokenInfoType.status:type_name -> Goiot.Protocol.Charger.AuthorizationStatus
	18,  // 88: Goiot.Protocol.Charger.IdTokenType.type:type_name -> Goiot.Protocol.Charger.IdTokenEnumType
	174, // 89: Goiot.Protocol.Charger.IdTokenType.additionalIdToken:type_name -> Goiot.Protocol.Charger.IdTokenType.Additional
	72,  // 90: Goiot.Protocol.Charger.AuthorizationData.idToken:type_name -> Goiot.Protocol.Charger.IdToken
	29,  // 91: Goiot.Protocol.Charger.SendLocalAuthorizationListReq.update_type:type_name -> Goiot.Protocol.Charger.SendLocalAuthorizationListReq.UpdateEnumType
	120, // 92: Goiot.Protocol.Charger.SendLocalAuthorizationListReq.local_authorization_list:type_name -> Goiot.Protocol.Charger.AuthorizationData
	30,  // 93: Goiot.Protocol.Charger.SendLocalAuthorizationListConf.status:type_name -> Goiot.Protocol.Charger.SendLocalAuthorizationListConf.Status
	72,  // 94: Goiot.Protocol.Charger.ReserveNowReq.idToken:type_name -> Goiot.Protocol.Charger.IdToken
	31,  // 95: Goiot.Protocol.Charger.ReserveNowConf.status:type_name -> Goiot.Protocol.Charger.ReserveNowConf.Status
	32,  // 96: Goiot.Protocol.Charger.CancelReservationConf.status:type_name -> Goiot.Protocol.Charger.CancelReservationConf.Status
	131, // 97: Goiot.Protocol.Charger.ReserveStopTransactionReq.idToken:type_name -> Goiot.Protocol.Charger.Token
	33,  // 98: Goiot.Protocol.Charger.DataTransferConf.status:type_name -> Goiot.Protocol.Charger.DataTransferConf.Status
	106, // 99: Goiot.Protocol.Charger.GetReportReq.component:type_name -> Goiot.Protocol.Charger.ComponentType
	139, // 100: Goiot.Protocol.Charger.GetVariablesReq.getVariablesData:type_name -> Goiot.Protocol.Charger.GetVariablesData
	106, // 101: Goiot.Protocol.Charger.GetVariablesData.component:type_name -> Goiot.Protocol.Charger.ComponentType
	107, // 102: Goiot.Protocol.Charger.GetVariablesData.variable:type_name -> Goiot.Protocol.Charger.VariableType
	141, // 103: Goiot.Protocol.Charger.GetVariablesConf.getVariablesResult:type_name -> Goiot.Protocol.Charger.GetVariablesResult
	106, // 104: Goiot.Protocol.Charger.GetVariablesResult.component:type_name -> Goiot.Protocol.Charger.ComponentType
	107, // 105: Goiot.Protocol.Charger.GetVariablesResult.variable:type_name -> Goiot.Protocol.Charger.VariableType
	143, // 106: Goiot.Protocol.Charger.SetChargingProfileReq.chargingProfile:type_name -> Goiot.Protocol.Charger.ChargingProfile
	144, // 107: Goiot.Protocol.Charger.ChargingProfile.chargingSchedule:type_name -> Goiot.Protocol.Charger.ChargingSchedule
	19,  // 108: Goiot.Protocol.Charger.ChargingSchedule.chargingRateUnit:type_name -> Goiot.Protocol.Charger.ChargingRateUnit
	175, // 109: Goiot.Protocol.Charger.ChargingSchedule.chargingSchedulePeriod:type_name -> Goiot.Protocol.Charger.ChargingSchedule.PeriodType
	176, // 110: Goiot.Protocol.Charger.SalesTariff.entry:type_name -> Goiot.Protocol.Charger.SalesTariff.Entry
	35,  // 111: Goiot.Protocol.Charger.SetChargingProfileConf.status:type_name -> Goiot.Protocol.Charger.ChargingProfile.Status
	148, // 112: Goiot.Protocol.Charger.ClearChargingProfileReq.clearChargingProfile:type_name -> Goiot.Protocol.Charger.ClearChargingProfile
	34,  // 113: Goiot.Protocol.Charger.ClearChargingProfile.purpose:type_name -> Goiot.Protocol.Charger.ChargingProfile.Purpose
	37,  // 114: Goiot.Protocol.Charger.ClearChargingProfileConf.status:type_name -> Goiot.Protocol.Charger.ClearChargingProfile.Status
	152, // 115: Goiot.Protocol.Charger.GetChargingProfilesReq.criterion:type_name -> Goiot.Protocol.Charger.ChargingProfilesCriterion
	20,  // 116: Goiot.Protocol.Charger.GetChargingProfilesConf.status:type_name -> Goiot.Protocol.Charger.GetChargingProfilesStatus
	143, // 117: Goiot.Protocol.Charger.ReportChargingProfilesReq.chargingProfile:type_name -> Goiot.Protocol.Charger.ChargingProfile
	21,  // 118: Goiot.Protocol.Charger.ReservationStatusUpdateReq.status:type_name -> Goiot.Protocol.Charger.ReservationStatusUpdate
	38,  // 119: Goiot.Protocol.Charger.SignCertificateConf.status:type_name -> Goiot.Protocol.Charger.SignCertificateConf.Status
	39,  // 120: Goiot.Protocol.Charger.ChangeAvailabilityConf.status:type_name -> Goiot.Protocol.Charger.ChangeAvailabilityConf.Status
	40,  // 121: Goiot.Protocol.Charger.InstallCertificateConf.status:type_name -> Goiot.Protocol.Charger.InstallCertificateConf.Status
	19,  // 122: Goiot.Protocol.Charger.CurrentChargingProfile.unit:type_name -> Goiot.Protocol.Charger.ChargingRateUnit
	41,  // 123: Goiot.Protocol.Charger.ClearCacheConf.status:type_name -> Goiot.Protocol.Charger.ClearCacheConf.Status
	69,  // 124: Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry.value:type_name -> Goiot.Protocol.Charger.TariffChannel
	8,   // 125: Goiot.Protocol.Charger.IdToken.Additional.mode:type_name -> Goiot.Protocol.Charger.AuthorizationMode
	106, // 126: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData.component:type_name -> Goiot.Protocol.Charger.ComponentType
	107, // 127: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData.variable:type_name -> Goiot.Protocol.Charger.VariableType
	18,  // 128: Goiot.Protocol.Charger.IdTokenType.Additional.type:type_name -> Goiot.Protocol.Charger.IdTokenEnumType
	177, // 129: Goiot.Protocol.Charger.SalesTariff.Entry.consumptionCost:type_name -> Goiot.Protocol.Charger.SalesTariff.ConsumptionCost
	178, // 130: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.cost:type_name -> Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost
	36,  // 131: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost.kind:type_name -> Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost.Kind
