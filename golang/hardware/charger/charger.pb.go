...
type RemoteStartTransactionReq struct {
	...
	ScheduleTime    int64            `protobuf:"varint,12,opt,name=schedule_time,json=scheduleTime,proto3" json:"schedule_time,omitempty"`                  // 定时充电时间戳(秒), 0表示即时充电
...
func (x *RemoteStartTransactionReq) GetScheduleTime() int64 {
	if x != nil {
