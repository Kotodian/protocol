...
type ReserveNowReq struct {
	...
	EvseId         int32        `protobuf:"varint,5,opt,name=evse_id,json=evseId,proto3" json:"evse_id,omitempty"`
}
...
func (x *ReserveNowReq) GetEvseId() int32 {
	if x != nil {
		return x.EvseId
	}
	return 0
...
var file_charger_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x65, 0x76, 0x73,
