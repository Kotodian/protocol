...
var file_charger_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x04, 0x46, 0x75, 0x6c, 0x6c, 0x10, 0x01, 0x22, 0x20, 0x0a, 0x1e, 0x53, 0x65, 0x6e,
	0x64, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x22, 0xc4, 0x01, 0x0a, 0x0d,
	...
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x22, 0xb0, 0x01, 0x0a, 0x0e, 0x4d,
	...
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x72, 0x69, 0x63, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x65, 0x6c,
	0x65, 0x63, 0x74, 0x72, 0x69, 0x63, 0x69, 0x74, 0x79, 0x12, 0x24, 0x0a, 0x0d, 0x74, 0x72, 0x61,
	...
	0x0a, 0x0a, 0x41, 0x53, 0x5f, 0x55, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x10, 0x63, 0x2a, 0xed,
	...
	0x4d, 0x5f, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x10, 0x0a, 0x2a, 0x8e,
	...
	,
...
var file_charger_proto_enumTypes = make([]protoimpl.EnumInfo, 39)
...
var file_charger_proto_goTypes = []interface{}{
	...
	(ReserveNowConf_Status)(0),                            // 29: Goiot.Protocol.Charger.ReserveNowConf.Status
	(CancelReservationConf_Status)(0),                     // 30: Goiot.Protocol.Charger.CancelReservationConf.Status
	(DataTransferConf_Status)(0),                          // 31: Goiot.Protocol.Charger.DataTransferConf.Status
	(ChargingProfile_Purpose)(0),                          // 32: Goiot.Protocol.Charger.ChargingProfile.Purpose
	(ChargingProfile_Status)(0),                           // 33: Goiot.Protocol.Charger.ChargingProfile.Status
	(SalesTariff_ConsumptionCost_Cost_Kind)(0),            // 34: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost.Kind
	(ClearChargingProfile_Status)(0),                      // 35: Goiot.Protocol.Charger.ClearChargingProfile.Status
	(SignCertificateConf_Status)(0),                       // 36: Goiot.Protocol.Charger.SignCertificateConf.Status
	(ChangeAvailabilityConf_Status)(0),                    // 37: Goiot.Protocol.Charger.ChangeAvailabilityConf.Status
	(InstallCertificateConf_Status)(0),                    // 38: Goiot.Protocol.Charger.InstallCertificateConf.Status
	(*APDU)(nil),                                          // 39: Goiot.Protocol.Charger.APDU
	(*MessageError)(nil),                                  // 40: Goiot.Protocol.Charger.MessageError
	(*BootNotificationReq)(nil),                           // 41: Goiot.Protocol.Charger.BootNotificationReq
	(*BootNotificationConf)(nil),                          // 42: Goiot.Protocol.Charger.BootNotificationConf
	(*KeyValue)(nil),                                      // 43: Goiot.Protocol.Charger.KeyValue
	(*ChangeConfigurationReq)(nil),                        // 44: Goiot.Protocol.Charger.ChangeConfigurationReq
	(*ChangeConfigurationConf)(nil),                       // 45: Goiot.Protocol.Charger.ChangeConfigurationConf
	(*GetConfigurationReq)(nil),                           // 46: Goiot.Protocol.Charger.GetConfigurationReq
	(*GetConfigurationConf)(nil),                          // 47: Goiot.Protocol.Charger.GetConfigurationConf
	(*RemoteControlReq)(nil),                              // 48: Goiot.Protocol.Charger.RemoteControlReq
	(*RemoteControlConf)(nil),                             // 49: Goiot.Protocol.Charger.RemoteControlConf
	(*UpdateFirmwareReq)(nil),                             // 50: Goiot.Protocol.Charger.UpdateFirmwareReq
	(*UpdateFirmwareConf)(nil),                            // 51: Goiot.Protocol.Charger.UpdateFirmwareConf
	(*FirmwareStatusNotificationReq)(nil),                 // 52: Goiot.Protocol.Charger.FirmwareStatusNotificationReq
	(*FirmwareStatusNotificationConf)(nil),                // 53: Goiot.Protocol.Charger.FirmwareStatusNotificationConf
	(*GetDiagnosticsReq)(nil),                             // 54: Goiot.Protocol.Charger.GetDiagnosticsReq
	(*GetDiagnosticsConf)(nil),                            // 55: Goiot.Protocol.Charger.GetDiagnosticsConf
	(*DiagnosticsStatusNotificationReq)(nil),              // 56: Goiot.Protocol.Charger.DiagnosticsStatusNotificationReq
	(*DeviceRegistrationReq)(nil),                         // 57: Goiot.Protocol.Charger.DeviceRegistrationReq
	(*DeviceRegistrationConf)(nil),                        // 58: Goiot.Protocol.Charger.DeviceRegistrationConf
	(*TriggerMessageReq)(nil),                             // 59: Goiot.Protocol.Charger.TriggerMessageReq
	(*TriggerMessageConf)(nil),                            // 60: Goiot.Protocol.Charger.TriggerMessageConf
	(*TariffTime)(nil),                                    // 61: Goiot.Protocol.Charger.TariffTime
	(*TariffCharge)(nil),                                  // 62: Goiot.Protocol.Charger.TariffCharge
	(*TariffParking)(nil),                                 // 63: Goiot.Protocol.Charger.TariffParking
	(*CostBill)(nil),                                      // 64: Goiot.Protocol.Charger.CostBill
	(*Cost)(nil),                                          // 65: Goiot.Protocol.Charger.Cost
	(*TariffChannel)(nil),                                 // 66: Goiot.Protocol.Charger.TariffChannel
	(*SetTariffReq)(nil),                                  // 67: Goiot.Protocol.Charger.SetTariffReq
	(*SetTariffConf)(nil),                                 // 68: Goiot.Protocol.Charger.SetTariffConf
	(*IdToken)(nil),                                       // 69: Goiot.Protocol.Charger.IdToken
	(*AuthorizeReq)(nil),                                  // 70: Goiot.Protocol.Charger.AuthorizeReq
	(*AuthorizeConf)(nil),                                 // 71: Goiot.Protocol.Charger.AuthorizeConf
	(*UpdateIdCardCacheReq)(nil),                          // 72: Goiot.Protocol.Charger.UpdateIdCardCacheReq
	(*HeartbeatReq)(nil),                                  // 73: Goiot.Protocol.Charger.HeartbeatReq
	(*HeartbeatResp)(nil),                                 // 74: Goiot.Protocol.Charger.HeartbeatResp
	(*RemoteStartTransactionReq)(nil),                     // 75: Goiot.Protocol.Charger.RemoteStartTransactionReq
	(*RemoteStartTransactionConf)(nil),                    // 76: Goiot.Protocol.Charger.RemoteStartTransactionConf
	(*RemoteStopTransactionReq)(nil),                      // 77: Goiot.Protocol.Charger.RemoteStopTransactionReq
	(*RemoteStopTransactionConf)(nil),                     // 78: Goiot.Protocol.Charger.RemoteStopTransactionConf
	(*StartTransactionReq)(nil),                           // 79: Goiot.Protocol.Charger.StartTransactionReq
	(*StartTransactionConf)(nil),                          // 80: Goiot.Protocol.Charger.StartTransactionConf
	(*StopTransactionReq)(nil),                            // 81: Goiot.Protocol.Charger.StopTransactionReq
	(*StopTransactionConf)(nil),                           // 82: Goiot.Protocol.Charger.StopTransactionConf
	(*BMSHandshakeInfo)(nil),                              // 83: Goiot.Protocol.Charger.BMSHandshakeInfo
	(*BMSConfigInfo)(nil),                                 // 84: Goiot.Protocol.Charger.BMSConfigInfo
	(*BMSChargingInfo)(nil),                               // 85: Goiot.Protocol.Charger.BMSChargingInfo
	(*BMSChargedInfo)(nil),                                // 86: Goiot.Protocol.Charger.BMSChargedInfo
	(*Cell)(nil),                                          // 87: Goiot.Protocol.Charger.Cell
	(*ChargingInfoReq)(nil),                               // 88: Goiot.Protocol.Charger.ChargingInfoReq
	(*TransactionReq)(nil),                                // 89: Goiot.Protocol.Charger.TransactionReq
	(*TransactionConf)(nil),                               // 90: Goiot.Protocol.Charger.TransactionConf
	(*SampledValue)(nil),                                  // 91: Goiot.Protocol.Charger.SampledValue
	(*TelemetryReq)(nil),                                  // 92: Goiot.Protocol.Charger.TelemetryReq
	(*WarningReq)(nil),                                    // 93: Goiot.Protocol.Charger.WarningReq
	(*WarningConf)(nil),                                   // 94: Goiot.Protocol.Charger.WarningConf
	(*GetTransactionsReq)(nil),                            // 95: Goiot.Protocol.Charger.GetTransactionsReq
	(*GetTransactionsConf)(nil),                           // 96: Goiot.Protocol.Charger.GetTransactionsConf
	(*GetWarningReq)(nil),                                 // 97: Goiot.Protocol.Charger.GetWarningReq
	(*GetWarningConf)(nil),                                // 98: Goiot.Protocol.Charger.GetWarningConf
	(*GetBaseReportConf)(nil),                             // 99: Goiot.Protocol.Charger.GetBaseReportConf
	(*GetBaseReportReq)(nil),                              // 100: Goiot.Protocol.Charger.GetBaseReportReq
	(*NotifyReportReq)(nil),                               // 101: Goiot.Protocol.Charger.NotifyReportReq
	(*ReportDataType)(nil),                                // 102: Goiot.Protocol.Charger.ReportDataType
	(*ComponentType)(nil),                                 // 103: Goiot.Protocol.Charger.ComponentType
	(*VariableType)(nil),                                  // 104: Goiot.Protocol.Charger.VariableType
	(*VariableAttributeType)(nil),                         // 105: Goiot.Protocol.Charger.VariableAttributeType
	(*NotifyReportConf)(nil),                              // 106: Goiot.Protocol.Charger.NotifyReportConf
	(*SetVariablesReq)(nil),                               // 107: Goiot.Protocol.Charger.SetVariablesReq
	(*SetVariablesConf)(nil),                              // 108: Goiot.Protocol.Charger.SetVariablesConf
	(*GetLogReq)(nil),                                     // 109: Goiot.Protocol.Charger.GetLogReq
	(*GetLogConf)(nil),                                    // 110: Goiot.Protocol.Charger.GetLogConf
	(*LogStatusNotificationReq)(nil),                      // 111: Goiot.Protocol.Charger.LogStatusNotificationReq
	(*LogStatusNotificationConf)(nil),                     // 112: Goiot.Protocol.Charger.LogStatusNotificationConf
	(*GetLocalListVersionReq)(nil),                        // 113: Goiot.Protocol.Charger.GetLocalListVersionReq
	(*GetLocalListVersionConf)(nil),                       // 114: Goiot.Protocol.Charger.GetLocalListVersionConf
	(*IdTokenInfoType)(nil),                               // 115: Goiot.Protocol.Charger.IdTokenInfoType
	(*IdTokenType)(nil),                                   // 116: Goiot.Protocol.Charger.IdTokenType
	(*AuthorizationData)(nil),                             // 117: Goiot.Protocol.Charger.AuthorizationData
	(*SendLocalAuthorizationListReq)(nil),                 // 118: Goiot.Protocol.Charger.SendLocalAuthorizationListReq
	(*SendLocalAuthorizationListConf)(nil),                // 119: Goiot.Protocol.Charger.SendLocalAuthorizationListConf
	(*ReserveNowReq)(nil),                                 // 120: Goiot.Protocol.Charger.ReserveNowReq
	(*ReserveNowConf)(nil),                                // 121: Goiot.Protocol.Charger.ReserveNowConf
	(*CancelReservationReq)(nil),                          // 122: Goiot.Protocol.Charger.CancelReservationReq
	(*CancelReservationConf)(nil),                         // 123: Goiot.Protocol.Charger.CancelReservationConf
	(*DataTransferReq)(nil),                               // 124: Goiot.Protocol.Charger.DataTransferReq
	(*RemoteDiagnosisReq)(nil),                            // 125: Goiot.Protocol.Charger.RemoteDiagnosisReq
	(*RemoteDiagnosisResp)(nil),                           // 126: Goiot.Protocol.Charger.RemoteDiagnosisResp
	(*ReserveStopTransactionReq)(nil),                     // 127: Goiot.Protocol.Charger.ReserveStopTransactionReq
	(*Token)(nil),                                         // 128: Goiot.Protocol.Charger.Token
	(*DataTransferConf)(nil),                              // 129: Goiot.Protocol.Charger.DataTransferConf
	(*CancelReserveStopTransactionReq)(nil),               // 130: Goiot.Protocol.Charger.CancelReserveStopTransactionReq
	(*StatusNotificationReq)(nil),                         // 131: Goiot.Protocol.Charger.StatusNotificationReq
	(*GetReportReq)(nil),                                  // 132: Goiot.Protocol.Charger.GetReportReq
	(*GetReportConf)(nil),                                 // 133: Goiot.Protocol.Charger.GetReportConf
	(*GetVariablesReq)(nil),                               // 134: Goiot.Protocol.Charger.GetVariablesReq
	(*GetVariablesData)(nil),                              // 135: Goiot.Protocol.Charger.GetVariablesData
	(*GetVariablesConf)(nil),                              // 136: Goiot.Protocol.Charger.GetVariablesConf
	(*GetVariablesResult)(nil),                            // 137: Goiot.Protocol.Charger.GetVariablesResult
	(*SetChargingProfileReq)(nil),                         // 138: Goiot.Protocol.Charger.SetChargingProfileReq
	(*ChargingProfile)(nil),                               // 139: Goiot.Protocol.Charger.ChargingProfile
	(*ChargingSchedule)(nil),                              // 140: Goiot.Protocol.Charger.ChargingSchedule
	(*SalesTariff)(nil),                                   // 141: Goiot.Protocol.Charger.SalesTariff
	(*SetChargingProfileConf)(nil),                        // 142: Goiot.Protocol.Charger.SetChargingProfileConf
	(*ClearChargingProfileReq)(nil),                       // 143: Goiot.Protocol.Charger.ClearChargingProfileReq
	(*ClearChargingProfile)(nil),                          // 144: Goiot.Protocol.Charger.ClearChargingProfile
	(*ClearChargingProfileConf)(nil),                      // 145: Goiot.Protocol.Charger.ClearChargingProfileConf
	(*GetChargingProfilesReq)(nil),                        // 146: Goiot.Protocol.Charger.GetChargingProfilesReq
	(*GetChargingProfilesConf)(nil),                       // 147: Goiot.Protocol.Charger.GetChargingProfilesConf
	(*ChargingProfilesCriterion)(nil),                     // 148: Goiot.Protocol.Charger.ChargingProfilesCriterion
	(*ReportChargingProfilesReq)(nil),                     // 149: Goiot.Protocol.Charger.ReportChargingProfilesReq
	(*ReportChargingProfilesConf)(nil),                    // 150: Goiot.Protocol.Charger.ReportChargingProfilesConf
	(*MeterValuesReq)(nil),                                // 151: Goiot.Protocol.Charger.MeterValuesReq
	(*ReservationStatusUpdateReq)(nil),                    // 152: Goiot.Protocol.Charger.ReservationStatusUpdateReq
	(*ReservationStatusUpdateConf)(nil),                   // 153: Goiot.Protocol.Charger.ReservationStatusUpdateConf
	(*SignCertificateReq)(nil),                            // 154: Goiot.Protocol.Charger.SignCertificateReq
	(*SignCertificateConf)(nil),                           // 155: Goiot.Protocol.Charger.SignCertificateConf
	(*ChangeAvailabilityReq)(nil),                         // 156: Goiot.Protocol.Charger.ChangeAvailabilityReq
	(*ChangeAvailabilityConf)(nil),                        // 157: Goiot.Protocol.Charger.ChangeAvailabilityConf
	(*InstallCertificateReq)(nil),                         // 158: Goiot.Protocol.Charger.InstallCertificateReq
	(*InstallCertificateConf)(nil),                        // 159: Goiot.Protocol.Charger.InstallCertificateConf
	(*Tariff)(nil),                                        // 160: Goiot.Protocol.Charger.Tariff
	(*CurrentChargingProfile)(nil),                        // 161: Goiot.Protocol.Charger.CurrentChargingProfile
	nil,                                                   // 162: Goiot.Protocol.Charger.TariffChannel.ElecEntry
	nil,                                                   // 163: Goiot.Protocol.Charger.TariffChannel.ServiceEntry
	nil,                                                   // 164: Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry
	(*SetVariablesReq_SetVariableData)(nil),               // 165: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData
	(*GetLogReq_LogParametersType)(nil),                   // 166: Goiot.Protocol.Charger.GetLogReq.LogParametersType
	(*ChargingSchedule_PeriodType)(nil),                   // 167: Goiot.Protocol.Charger.ChargingSchedule.PeriodType
	(*SalesTariff_Entry)(nil),                             // 168: Goiot.Protocol.Charger.SalesTariff.Entry
	(*SalesTariff_ConsumptionCost)(nil),                   // 169: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost
	(*SalesTariff_ConsumptionCost_Cost)(nil),              // 170: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost
}
var file_charger_proto_depIdxs = []int32{
	...
	43,  // 2: Goiot.Protocol.Charger.ChangeConfigurationReq.configurationKey:type_name -> Goiot.Protocol.Charger.KeyValue
	2,   // 3: Goiot.Protocol.Charger.ChangeConfigurationConf.status:type_name -> Goiot.Protocol.Charger.ConfigurationStatus
	43,  // 4: Goiot.Protocol.Charger.GetConfigurationReq.keys:type_name -> Goiot.Protocol.Charger.KeyValue
	43,  // 5: Goiot.Protocol.Charger.GetConfigurationConf.values:type_name -> Goiot.Protocol.Charger.KeyValue
	...
	64,  // 11: Goiot.Protocol.Charger.Cost.bills:type_name -> Goiot.Protocol.Charger.CostBill
	162, // 12: Goiot.Protocol.Charger.TariffChannel.elec:type_name -> Goiot.Protocol.Charger.TariffChannel.ElecEntry
	163, // 13: Goiot.Protocol.Charger.TariffChannel.service:type_name -> Goiot.Protocol.Charger.TariffChannel.ServiceEntry
	62,  // 14: Goiot.Protocol.Charger.SetTariffReq.chargetariffs:type_name -> Goiot.Protocol.Charger.TariffCharge
	61,  // 15: Goiot.Protocol.Charger.SetTariffReq.timetariffs:type_name -> Goiot.Protocol.Charger.TariffTime
	63,  // 16: Goiot.Protocol.Charger.SetTariffReq.parkingtariffs:type_name -> Goiot.Protocol.Charger.TariffParking
	164, // 17: Goiot.Protocol.Charger.SetTariffReq.channels:type_name -> Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry
	...
	69,  // 21: Goiot.Protocol.Charger.AuthorizeReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	8,   // 22: Goiot.Protocol.Charger.AuthorizeReq.authorization_mode:type_name -> Goiot.Protocol.Charger.AuthorizationMode
	69,  // 23: Goiot.Protocol.Charger.AuthorizeConf.idInfo:type_name -> Goiot.Protocol.Charger.IdToken
	67,  // 24: Goiot.Protocol.Charger.AuthorizeConf.priceScheme:type_name -> Goiot.Protocol.Charger.SetTariffReq
	69,  // 25: Goiot.Protocol.Charger.UpdateIdCardCacheReq.cardinfo:type_name -> Goiot.Protocol.Charger.IdToken
	69,  // 26: Goiot.Protocol.Charger.RemoteStartTransactionReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	9,   // 27: Goiot.Protocol.Charger.RemoteStartTransactionReq.serviceMode:type_name -> Goiot.Protocol.Charger.ServiceMode
	67,  // 28: Goiot.Protocol.Charger.RemoteStartTransactionReq.priceScheme:type_name -> Goiot.Protocol.Charger.SetTariffReq
	139, // 29: Goiot.Protocol.Charger.RemoteStartTransactionReq.chargingProfile:type_name -> Goiot.Protocol.Charger.ChargingProfile
	...
	69,  // 32: Goiot.Protocol.Charger.StartTransactionReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	...
	160, // 36: Goiot.Protocol.Charger.StartTransactionReq.tariff:type_name -> Goiot.Protocol.Charger.Tariff
	161, // 37: Goiot.Protocol.Charger.StartTransactionReq.profile:type_name -> Goiot.Protocol.Charger.CurrentChargingProfile
	69,  // 38: Goiot.Protocol.Charger.StartTransactionConf.idInfo:type_name -> Goiot.Protocol.Charger.IdToken
	69,  // 39: Goiot.Protocol.Charger.StopTransactionReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	10,  // 40: Goiot.Protocol.Charger.StopTransactionReq.reason:type_name -> Goiot.Protocol.Charger.StopReason
	65,  // 41: Goiot.Protocol.Charger.StopTransactionReq.cost:type_name -> Goiot.Protocol.Charger.Cost
	160, // 42: Goiot.Protocol.Charger.StopTransactionReq.tariff:type_name -> Goiot.Protocol.Charger.Tariff
	161, // 43: Goiot.Protocol.Charger.StopTransactionReq.profile:type_name -> Goiot.Protocol.Charger.CurrentChargingProfile
	...
	87,  // 46: Goiot.Protocol.Charger.BMSChargingInfo.highestVoltage:type_name -> Goiot.Protocol.Charger.Cell
	87,  // 47: Goiot.Protocol.Charger.BMSChargingInfo.highestTemp:type_name -> Goiot.Protocol.Charger.Cell
	87,  // 48: Goiot.Protocol.Charger.BMSChargingInfo.lowestTemp:type_name -> Goiot.Protocol.Charger.Cell
	...
	87,  // 55: Goiot.Protocol.Charger.BMSChargingInfo.cellVoltage:type_name -> Goiot.Protocol.Charger.Cell
	87,  // 56: Goiot.Protocol.Charger.BMSChargingInfo.cellTemperature:type_name -> Goiot.Protocol.Charger.Cell
	11,  // 57: Goiot.Protocol.Charger.BMSChargingInfo.batType:type_name -> Goiot.Protocol.Charger.BatteryType
	65,  // 58: Goiot.Protocol.Charger.ChargingInfoReq.cost:type_name -> Goiot.Protocol.Charger.Cost
	...
	160, // 61: Goiot.Protocol.Charger.ChargingInfoReq.tariff:type_name -> Goiot.Protocol.Charger.Tariff
	69,  // 62: Goiot.Protocol.Charger.ChargingInfoReq.idData:type_name -> Goiot.Protocol.Charger.IdToken
	161, // 63: Goiot.Protocol.Charger.ChargingInfoReq.profile:type_name -> Goiot.Protocol.Charger.CurrentChargingProfile
	69,  // 64: Goiot.Protocol.Charger.TransactionReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	...
	65,  // 68: Goiot.Protocol.Charger.TransactionReq.cost:type_name -> Goiot.Protocol.Charger.Cost
	16,  // 69: Goiot.Protocol.Charger.TelemetryReq.component:type_name -> Goiot.Protocol.Charger.Components
	91,  // 70: Goiot.Protocol.Charger.TelemetryReq.values:type_name -> Goiot.Protocol.Charger.SampledValue
	...
	102, // 75: Goiot.Protocol.Charger.NotifyReportReq.reportData:type_name -> Goiot.Protocol.Charger.ReportDataType
	103, // 76: Goiot.Protocol.Charger.ReportDataType.component:type_name -> Goiot.Protocol.Charger.ComponentType
	104, // 77: Goiot.Protocol.Charger.ReportDataType.variable:type_name -> Goiot.Protocol.Charger.VariableType
	105, // 78: Goiot.Protocol.Charger.ReportDataType.variableAttribute:type_name -> Goiot.Protocol.Charger.VariableAttributeType
	165, // 79: Goiot.Protocol.Charger.SetVariablesReq.setVariableData:type_name -> Goiot.Protocol.Charger.SetVariablesReq.SetVariableData
	25,  // 80: Goiot.Protocol.Charger.GetLogReq.logType:type_name -> Goiot.Protocol.Charger.GetLogReq.LogType
	166, // 81: Goiot.Protocol.Charger.GetLogReq.log:type_name -> Goiot.Protocol.Charger.GetLogReq.LogParametersType
	...
	115, // 86: Goiot.Protocol.Charger.AuthorizationData.idTokenInfo:type_name -> Goiot.Protocol.Charger.IdTokenInfoType
	116, // 87: Goiot.Protocol.Charger.AuthorizationData.idToken:type_name -> Goiot.Protocol.Charger.IdTokenType
	...
	117, // 89: Goiot.Protocol.Charger.SendLocalAuthorizationListReq.local_authorization_list:type_name -> Goiot.Protocol.Charger.AuthorizationData
	116, // 90: Goiot.Protocol.Charger.ReserveNowReq.idToken:type_name -> Goiot.Protocol.Charger.IdTokenType
	29,  // 91: Goiot.Protocol.Charger.ReserveNowConf.status:type_name -> Goiot.Protocol.Charger.ReserveNowConf.Status
	30,  // 92: Goiot.Protocol.Charger.CancelReservationConf.status:type_name -> Goiot.Protocol.Charger.CancelReservationConf.Status
	128, // 93: Goiot.Protocol.Charger.ReserveStopTransactionReq.idToken:type_name -> Goiot.Protocol.Charger.Token
	31,  // 94: Goiot.Protocol.Charger.DataTransferConf.status:type_name -> Goiot.Protocol.Charger.DataTransferConf.Status
	103, // 95: Goiot.Protocol.Charger.GetReportReq.component:type_name -> Goiot.Protocol.Charger.ComponentType
	135, // 96: Goiot.Protocol.Charger.GetVariablesReq.getVariablesData:type_name -> Goiot.Protocol.Charger.GetVariablesData
	103, // 97: Goiot.Protocol.Charger.GetVariablesData.component:type_name -> Goiot.Protocol.Charger.ComponentType
	104, // 98: Goiot.Protocol.Charger.GetVariablesData.variable:type_name -> Goiot.Protocol.Charger.VariableType
	137, // 99: Goiot.Protocol.Charger.GetVariablesConf.getVariablesResult:type_name -> Goiot.Protocol.Charger.GetVariablesResult
	103, // 100: Goiot.Protocol.Charger.GetVariablesResult.component:type_name -> Goiot.Protocol.Charger.ComponentType
	104, // 101: Goiot.Protocol.Charger.GetVariablesResult.variable:type_name -> Goiot.Protocol.Charger.VariableType
	139, // 102: Goiot.Protocol.Charger.SetChargingProfileReq.chargingProfile:type_name -> Goiot.Protocol.Charger.ChargingProfile
	140, // 103: Goiot.Protocol.Charger.ChargingProfile.chargingSchedule:type_name -> Goiot.Protocol.Charger.ChargingSchedule
	19,  // 104: Goiot.Protocol.Charger.ChargingSchedule.chargingRateUnit:type_name -> Goiot.Protocol.Charger.ChargingRateUnit
	167, // 105: Goiot.Protocol.Charger.ChargingSchedule.chargingSchedulePeriod:type_name -> Goiot.Protocol.Charger.ChargingSchedule.PeriodType
	168, // 106: Goiot.Protocol.Charger.SalesTariff.entry:type_name -> Goiot.Protocol.Charger.SalesTariff.Entry
	33,  // 107: Goiot.Protocol.Charger.SetChargingProfileConf.status:type_name -> Goiot.Protocol.Charger.ChargingProfile.Status
	144, // 108: Goiot.Protocol.Charger.ClearChargingProfileReq.clearChargingProfile:type_name -> Goiot.Protocol.Charger.ClearChargingProfile
	32,  // 109: Goiot.Protocol.Charger.ClearChargingProfile.purpose:type_name -> Goiot.Protocol.Charger.ChargingProfile.Purpose
	35,  // 110: Goiot.Protocol.Charger.ClearChargingProfileConf.status:type_name -> Goiot.Protocol.Charger.ClearChargingProfile.Status
	148, // 111: Goiot.Protocol.Charger.GetChargingProfilesReq.criterion:type_name -> Goiot.Protocol.Charger.ChargingProfilesCriterion
	20,  // 112: Goiot.Protocol.Charger.GetChargingProfilesConf.status:type_name -> Goiot.Protocol.Charger.GetChargingProfilesStatus
	139, // 113: Goiot.Protocol.Charger.ReportChargingProfilesReq.chargingProfile:type_name -> Goiot.Protocol.Charger.ChargingProfile
	21,  // 114: Goiot.Protocol.Charger.ReservationStatusUpdateReq.status:type_name -> Goiot.Protocol.Charger.ReservationStatusUpdate
	36,  // 115: Goiot.Protocol.Charger.SignCertificateConf.status:type_name -> Goiot.Protocol.Charger.SignCertificateConf.Status
	37,  // 116: Goiot.Protocol.Charger.ChangeAvailabilityConf.status:type_name -> Goiot.Protocol.Charger.ChangeAvailabilityConf.Status
	38,  // 117: Goiot.Protocol.Charger.InstallCertificateConf.status:type_name -> Goiot.Protocol.Charger.InstallCertificateConf.Status
	19,  // 118: Goiot.Protocol.Charger.CurrentChargingProfile.unit:type_name -> Goiot.Protocol.Charger.ChargingRateUnit
	66,  // 119: Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry.value:type_name -> Goiot.Protocol.Charger.TariffChannel
	103, // 120: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData.component:type_name -> Goiot.Protocol.Charger.ComponentType
	104, // 121: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData.variable:type_name -> Goiot.Protocol.Charger.VariableType
	169, // 122: Goiot.Protocol.Charger.SalesTariff.Entry.consumptionCost:type_name -> Goiot.Protocol.Charger.SalesTariff.ConsumptionCost
	170, // 123: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.cost:type_name -> Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost
	34,  // 124: Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost.kind:type_name -> Goiot.Protocol.Charger.SalesTariff.ConsumptionCost.Cost.Kind
