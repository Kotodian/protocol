...
type SalesTariff_Cost_Kind int32

const (
	SalesTariff_Cost_CarbonDioxideEmission         SalesTariff_Cost_Kind = 0
	SalesTariff_Cost_RelativePricePercentage       SalesTariff_Cost_Kind = 1
	SalesTariff_Cost_RenewableGenerationPercentage SalesTariff_Cost_Kind = 2
)

// Enum value maps for SalesTariff_Cost_Kind.
var (
	SalesTariff_Cost_Kind_name = map[int32]string{
		0: "CarbonDioxideEmission",
		1: "RelativePricePercentage",
		2: "RenewableGenerationPercentage",
	}
	SalesTariff_Cost_Kind_value = map[string]int32{
...
func (x SalesTariff_Cost_Kind) Enum() *SalesTariff_Cost_Kind {
	p := new(SalesTariff_Cost_Kind)
	*p = x
	return p
}

func (x SalesTariff_Cost_Kind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SalesTariff_Cost_Kind) Descriptor() protoreflect.EnumDescriptor {
	return file_charger_proto_enumTypes[32].Descriptor()
}

func (SalesTariff_Cost_Kind) Type() protoreflect.EnumType {
	return &file_charger_proto_enumTypes[32]
}

func (x SalesTariff_Cost_Kind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SalesTariff_Cost_Kind.Descriptor instead.
func (SalesTariff_Cost_Kind) EnumDescriptor() ([]byte, []int) {
...
type ChargingSchedule struct {
	...
	MinChargingRate        float32                        `protobuf:"fixed32,5,opt,name=minChargingRate,proto3" json:"minChargingRate,omitempty"`
...
func (x *ChargingSchedule) GetMinChargingRate() float32 {
	if x != nil {
...
func (x *ChargingSchedule_PeriodType) GetLimit() float32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type SalesTariff_Entry struct {
	...
	Duration         int32                 `protobuf:"varint,3,opt,name=duration,proto3" json:"duration,omitempty"`
	StartValue       float32               `protobuf:"fixed32,4,opt,name=startValue,proto3" json:"startValue,omitempty"`
	CostKind         SalesTariff_Cost_Kind `protobuf:"varint,5,opt,name=costKind,proto3,enum=Goiot.Protocol.Charger.SalesTariff_Cost_Kind" json:"costKind,omitempty"`
	Amount           int32                 `protobuf:"varint,6,opt,name=amount,proto3" json:"amount,omitempty"`
	AmountMultiplier int32                 `protobuf:"varint,7,opt,name=amountMultiplier,proto3" json:"amountMultiplier,omitempty"`
}
...
func (x *SalesTariff_Entry) GetStartValue() float32 {
	if x != nil {
		return x.StartValue
	}
	return 0
...
func (x *SalesTariff_Entry) GetCostKind() SalesTariff_Cost_Kind {
	if x != nil {
		return x.CostKind
	}
	return SalesTariff_Cost_CarbonDioxideEmission
}

func (x *SalesTariff_Entry) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *SalesTariff_Entry) GetAmountMultiplier() int32 {
	if x != nil {
...
type SalesTariff_Cost struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *SalesTariff_Cost) Reset() {
	*x = SalesTariff_Cost{}
	if protoimpl.UnsafeEnabled {
...
func (x *SalesTariff_Cost) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SalesTariff_Cost) ProtoMessage() {}

func (x *SalesTariff_Cost) ProtoReflect() protoreflect.Message {
	mi := &file_charger_proto_msgTypes[110]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SalesTariff_Cost.ProtoReflect.Descriptor instead.
func (*SalesTariff_Cost) Descriptor() ([]byte, []int) {
...
var file_charger_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x6e, 0x67, 0x52, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0f,
	...
	0x01, 0x28, 0x02, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x6e, 0x75,
	...
	0x28, 0x05, 0x52, 0x0a, 0x70, 0x68, 0x61, 0x73, 0x65, 0x54, 0x6f, 0x55, 0x73, 0x65, 0x22, 0xb8,
	0x04, 0x0a, 0x0b, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x54, 0x61, 0x72, 0x69, 0x66, 0x66, 0x12, 0x0e,
	...
	0x79, 0x1a, 0x8a, 0x02, 0x0a, 0x05, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x65,
	...
	,
	...
	0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x61, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x1a, 0x69,
	0x0a, 0x04, 0x43, 0x6f, 0x73, 0x74, 0x22, 0x61, 0x0a, 0x04, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x19,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0x9e, 0x0f, 0x0a, 0x09,
	...
	0x52, 0x65, 0x71, 0x10, 0x42, 0x12, 0x1c, 0x0a, 0x17, 0x49, 0x44, 0x5f, 0x42, 0x6f, 0x6f, 0x74,
	...
	0x66, 0x10, 0x9a, 0x01, 0x12, 0x1b, 0x0a, 0x16, 0x49, 0x44, 0x5f, 0x47, 0x65, 0x74, 0x54, 0x72,
	...
	0x43, 0x68, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x43,
	0x6f, 0x6e, 0x66, 0x10, 0xbc, 0x01, 0x12, 0x14, 0x0a, 0x0f, 0x49, 0x44, 0x5f, 0x4d, 0x65, 0x73,
	...
	0x05, 0x2a, 0x92, 0x05, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e,
	...
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x10, 0x6c, 0x12, 0x16,
	0x0a, 0x0f, 0x53, 0x52, 0x5f, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x45, 0x72, 0x72, 0x6f,
	0x72, 0x10, 0xff, 0xc1, 0xd7, 0x2f, 0x2a, 0x9a, 0x01, 0x0a, 0x0b, 0x42, 0x61, 0x74, 0x74, 0x65,
...
var file_charger_proto_msgTypes = make([]protoimpl.MessageInfo, 111)
var file_charger_proto_goTypes = []interface{}{
	...
	(SalesTariff_Cost_Kind)(0),                            // 32: Goiot.Protocol.Charger.SalesTariff.Cost.Kind
	...
	nil,                                                   // 136: Goiot.Protocol.Charger.TariffChannel.ElecEntry
	nil,                                                   // 137: Goiot.Protocol.Charger.TariffChannel.ServiceEntry
	nil,                                                   // 138: Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry
	(*SetVariablesReq_SetVariableData)(nil),               // 139: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData
	(*GetLogReq_LogParametersType)(nil),                   // 140: Goiot.Protocol.Charger.GetLogReq.LogParametersType
	(*ChargingSchedule_PeriodType)(nil),                   // 141: Goiot.Protocol.Charger.ChargingSchedule.PeriodType
	(*SalesTariff_Entry)(nil),                             // 142: Goiot.Protocol.Charger.SalesTariff.Entry
	(*SalesTariff_Cost)(nil),                              // 143: Goiot.Protocol.Charger.SalesTariff.Cost
}
var file_charger_proto_depIdxs = []int32{
	...
	136, // 11: Goiot.Protocol.Charger.TariffChannel.elec:type_name -> Goiot.Protocol.Charger.TariffChannel.ElecEntry
	137, // 12: Goiot.Protocol.Charger.TariffChannel.service:type_name -> Goiot.Protocol.Charger.TariffChannel.ServiceEntry
	...
	138, // 16: Goiot.Protocol.Charger.SetTariffReq.channels:type_name -> Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry
	...
	62,  // 30: Goiot.Protocol.Charger.StartTransactionReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	...
	62,  // 34: Goiot.Protocol.Charger.StartTransactionConf.idInfo:type_name -> Goiot.Protocol.Charger.IdToken
	62,  // 35: Goiot.Protocol.Charger.StopTransactionReq.IdData:type_name -> Goiot.Protocol.Charger.IdToken
	10,  // 36: Goiot.Protocol.Charger.StopTransactionReq.reason:type_name -> Goiot.Protocol.Charger.StopReason
	58,  // 37: Goiot.Protocol.Charger.StopTransactionReq.cost:type_name -> Goiot.Protocol.Charger.Cost
	...
	80,  // 40: Goiot.Protocol.Charger.BMSChargingInfo.highestVoltage:type_name -> Goiot.Protocol.Charger.Cell
	80,  // 41: Goiot.Protocol.Charger.BMSChargingInfo.highestTemp:type_name -> Goiot.Protocol.Charger.Cell
	80,  // 42: Goiot.Protocol.Charger.BMSChargingInfo.lowestTemp:type_name -> Goiot.Protocol.Charger.Cell
	...
	80,  // 49: Goiot.Protocol.Charger.BMSChargingInfo.cellVoltage:type_name -> Goiot.Protocol.Charger.Cell
	80,  // 50: Goiot.Protocol.Charger.BMSChargingInfo.cellTemperature:type_name -> Goiot.Protocol.Charger.Cell
	11,  // 51: Goiot.Protocol.Charger.BMSChargingInfo.batType:type_name -> Goiot.Protocol.Charger.BatteryType
	78,  // 52: Goiot.Protocol.Charger.ChargingInfoReq.BMSCharging:type_name -> Goiot.Protocol.Charger.BMSChargingInfo
	...
	139, // 70: Goiot.Protocol.Charger.SetVariablesReq.setVariableData:type_name -> Goiot.Protocol.Charger.SetVariablesReq.SetVariableData
	22,  // 71: Goiot.Protocol.Charger.GetLogReq.logType:type_name -> Goiot.Protocol.Charger.GetLogReq.LogType
	140, // 72: Goiot.Protocol.Charger.GetLogReq.log:type_name -> Goiot.Protocol.Charger.GetLogReq.LogParametersType
	...
	141, // 101: Goiot.Protocol.Charger.ChargingSchedule.chargingSchedulePeriod:type_name -> Goiot.Protocol.Charger.ChargingSchedule.PeriodType
	134, // 102: Goiot.Protocol.Charger.ChargingSchedule.salesTariff:type_name -> Goiot.Protocol.Charger.SalesTariff
	142, // 103: Goiot.Protocol.Charger.SalesTariff.entry:type_name -> Goiot.Protocol.Charger.SalesTariff.Entry
	31,  // 104: Goiot.Protocol.Charger.SetChargingProfileConf.status:type_name -> Goiot.Protocol.Charger.ChargingProfile.Status
	59,  // 105: Goiot.Protocol.Charger.SetTariffReq.ChannelsEntry.value:type_name -> Goiot.Protocol.Charger.TariffChannel
	96,  // 106: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData.component:type_name -> Goiot.Protocol.Charger.ComponentType
	97,  // 107: Goiot.Protocol.Charger.SetVariablesReq.SetVariableData.variable:type_name -> Goiot.Protocol.Charger.VariableType
	32,  // 108: Goiot.Protocol.Charger.SalesTariff.Entry.costKind:type_name -> Goiot.Protocol.Charger.SalesTariff.Cost.Kind
